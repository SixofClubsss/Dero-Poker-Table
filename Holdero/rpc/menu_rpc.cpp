...
int Menu::setTable()      /// Owner set table player limit and ante
{
    ...
    QString sb = QString::number(ui->blindSpinBox->value()*100000, 'g', 10);
    QString bb = QString::number(ui->blindSpinBox->value()*100000*2, 'g', 10);
    QString parts = "{\"jsonrpc\":\"2.0\",\"id\":\"0\",\"method\":\"transfer\",\"params\":{\"transfers\":[{\"destination\":\"dero1qyr8yjnu6cl2c5yqkls0hmxe6rry77kn24nmc5fje6hm9jltyvdd5qq4hn5pn\"}] , \"fees\":500 , \"scid\":\""+Menu::contractAddress+"\", \"ringsize\":2 , \"sc_rpc\":[{\"name\":\"entrypoint\",\"datatype\":\"S\",\"value\":\"SetTable\"},{\"name\":\"seats\",\"datatype\":\"U\",\"value\":"+playerLimit+"}, {\"name\":\"bigBlind\",\"datatype\":\"U\",\"value\":"+bb+"}, {\"name\":\"smallBlind\",\"datatype\":\"U\",\"value\":"+sb+"}, {\"name\":\"ante\",\"datatype\":\"U\",\"value\":"+anteAmount+"}, {\"name\":\"address\",\"datatype\":\"S\",\"value\":\""+rpc::IdHash+"\" }] }}";
    string addThis = parts.toStdString();
    const char *postthis = addThis.c_str();
...
void Menu::unlockTable()   /// Unlocks contract file for use
{
    ...
    if(ui->daemonConnectedBox->isChecked() && ui->walletConnectedBox->isChecked() && Menu::mainnet == true){
        ...
        QString key("B8723E10B2CBBC0B8FCD6282C49D37C9C1ABC07123E1F482356C415F684407A3");
        QString iv("49132F774AE84E66D9D32DE74C7D9938");
...
int Menu::delistTable()      /// Owner can remove listing made by current address
{
    ...
    if(curlDelistTable) {
      ...
      curl_easy_setopt(curlDelistTable, CURLOPT_WRITEDATA, &delistTableReadBuffer);

      res = curl_easy_perform(curlDelistTable);
      curl_easy_cleanup(curlDelistTable);

      QByteArray br = delistTableReadBuffer.c_str();
      QJsonDocument cbDoc = QJsonDocument::fromJson(br);
      QJsonObject cbObj = cbDoc.object();
      QJsonObject cbResults = cbObj["result"].toObject();

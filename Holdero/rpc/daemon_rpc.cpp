...
int rpc::getBalance()  /// Gets players dero balance
{
    ...
    if(curlBalanceCheck) {
      ...
      curl_easy_setopt(curlBalanceCheck, CURLOPT_CONNECTTIMEOUT, 6L);
...
int rpc::getHeight()  /// Gets current block height
{
    ...
    if(curlHeightCheck) {
      ...
      curl_easy_setopt(curlHeightCheck, CURLOPT_CONNECTTIMEOUT, 6L);
...
int rpc::fetchScData()       /// Get SC variables
{
    ...
    if(curlFetch) {
      ...
      curl_easy_setopt(curlFetch, CURLOPT_CONNECTTIMEOUT, 6L);
      ...
      QJsonValue Count_jv = cbStringKeys.value("Counter:");
      QJsonValue Ante_jv = cbStringKeys.value("Ante:");
      QJsonValue BigBlind_jv = cbStringKeys.value("BB:");
      QJsonValue SmallBlind_jv = cbStringKeys.value("SB:");
      ...
      QJsonValue FlopBool_jv = cbStringKeys.value("Flop");
      QJsonValue TurnBool_jv = cbStringKeys.value("Turn");
      QJsonValue RiverBool_jv = cbStringKeys.value("River");
      ...
      QJsonValue flopcard1_jv = cbStringKeys.value("FlopCard1");
      QJsonValue flopcard2_jv = cbStringKeys.value("FlopCard2");
      QJsonValue flopcard3_jv = cbStringKeys.value("FlopCard3");
      QJsonValue turncard_jv = cbStringKeys.value("TurnCard");
      QJsonValue rivercard_jv = cbStringKeys.value("RiverCard");
      ...
      rpc::bigBlind = BigBlind_jv.toDouble();
      rpc::smallBlind = SmallBlind_jv.toDouble();
      ...
      rpc::flopBool = FlopBool_jv.toInt();
      rpc::turnBool = TurnBool_jv.toInt();
      rpc::riverBool = RiverBool_jv.toInt();
      ...
      rpc::flopCard1 = flopcard1_jv.toInt();
      rpc::flopCard2 = flopcard2_jv.toInt();
      rpc::flopCard3 = flopcard3_jv.toInt();
      rpc::turnCard = turncard_jv.toInt();
      rpc::riverCard = rivercard_jv.toInt();
